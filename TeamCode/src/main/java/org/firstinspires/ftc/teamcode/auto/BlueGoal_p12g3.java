...
public class BlueGoal_p12g3 extends OpMode {
    ...
    public void buildPaths() {
        ...
        openGate = follower.pathBuilder()
                .addPath(new BezierLine(pickup3Pose, gateSetup))
                .setLinearHeadingInterpolation(pickup3Pose.getHeading(), gateSetup.getHeading())
        ...
        scorePickup3 = follower.pathBuilder()
                .addPath(new BezierLine(gateOpen, scorePose3))
                .setLinearHeadingInterpolation(gateOpen.getHeading(), scorePose3.getHeading())
                .build();
