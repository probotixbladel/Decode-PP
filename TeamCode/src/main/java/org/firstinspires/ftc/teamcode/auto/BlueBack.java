...
public class BlueBack extends OpMode {
    ...
    private final Pose scorePosePreload = new Pose(60, 11, Math.toRadians(290)); // Scoring Pose of our robot for the preload. It is facing the goal at a -45 degree angle.
    private final Pose pickup1Setup = new Pose(17, 8, Math.toRadians(180)); // Setup to pickup balls in the hp zone
    private final Pose pickup1Pose = new Pose(8, 8, Math.toRadians(180));// balls in the hp zone
