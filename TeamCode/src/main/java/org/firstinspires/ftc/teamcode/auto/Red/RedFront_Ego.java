...
public class RedFront_Ego extends OpMode {
    ...
    private final Pose startPose = new Pose(126.57, 120.37, Math.toRadians(-144));
    private final Pose scorePoseStart = new Pose(106.87, 107.03, Math.toRadians(-136));
    private final Pose scorePoseFinal = new Pose(92.68, 93.54, Math.toRadians(-134));
    private final Pose pickup1Pose = new Pose(126.56, 83.92, Math.toRadians(0));
    private final Pose pickup1Controlpoint = new Pose(90.08, 83.07);
    private final Pose scorePose = new Pose(92.40, 93.92, Math.toRadians(-134));
    private final Pose pickup2Pose = new Pose(127.28, 59.93, Math.toRadians(0));
    private final Pose pickup2Controlpoint = new Pose(78.44, 61.39);
    private final Pose pickupGatePose = new Pose(132.79, 60.61, Math.toRadians(37));
    private final Pose pickupGateControlpoint = new Pose(90.04, 70.92);
    private final Pose pickup3Pose = new Pose(120.42, 35.08, Math.toRadians(0));
    private final Pose pickup3Controlpoint = new Pose(82.96, 32.74);
    private final Pose leavePose = new Pose(81.75, 64.65, Math.toRadians(90));
    private final Pose leaveControlpose = new Pose(70.04, 77.51);
