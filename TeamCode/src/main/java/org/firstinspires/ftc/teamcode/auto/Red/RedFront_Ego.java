...
public class RedFront_Ego extends OpMode {
    ...
    private final Pose startPose = new Pose(17.43, 120.37, Math.toRadians(-36)).mirror(fieldLength);
    private final Pose scorePoseStart = new Pose(37.13, 107.03, Math.toRadians(-44)).mirror(fieldLength);
    private final Pose scorePoseFinal = new Pose(51.32, 93.54, Math.toRadians(-46)).mirror(fieldLength);
    private final Pose pickup1Pose = new Pose(17.44, 83.92, Math.toRadians(180)).mirror(fieldLength);
    private final Pose pickup1Controlpoint = new Pose(53.92, 83.07).mirror(fieldLength);
    private final Pose pickup1PoseHalfway = new Pose(45, 83.92, Math.toRadians(180)).mirror(fieldLength);
    private final Pose scorePose = new Pose(51.60, 93.92, Math.toRadians(-46)).mirror(fieldLength);
    private final Pose pickup2Pose = new Pose(16.72, 59.93, Math.toRadians(180)).mirror(fieldLength);
    private final Pose pickup2Controlpoint = new Pose(65.56, 61.39).mirror(fieldLength);
    private final Pose pickup2PoseHalfway = new Pose(45, 59.93, Math.toRadians(180)).mirror(fieldLength);
    private final Pose pickupGatePose = new Pose(11.21, 60.61, Math.toRadians(143)).mirror(fieldLength);
    private final Pose pickupGateControlpoint = new Pose(53.96, 70.92).mirror(fieldLength);
    private final Pose pickup3Pose = new Pose(23.58, 35.08, Math.toRadians(180)).mirror(fieldLength);
    private final Pose pickup3Controlpoint = new Pose(61.04, 32.74).mirror(fieldLength);
    private final Pose pickup3PoseHalfway = new Pose(45, 35.08, Math.toRadians(180)).mirror(fieldLength);
    private final Pose leavePose = new Pose(62.25, 64.65, Math.toRadians(-90)).mirror(fieldLength);
    private final Pose leaveControlpose = new Pose(73.96, 77.51).mirror(fieldLength);
