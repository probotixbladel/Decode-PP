...
public class BlueBack_AllHp_With3 extends OpMode {
    ...
    private final Pose pickup3Pose = new Pose(20.73, 38.36, Math.toRadians(-180));
    private final Pose pickup3Controlpoint = new Pose(5, 56);
    private final Pose pickup3PoseHalfway = new Pose(45, 38.36, Math.toRadians(-180));
    private final Pose pickupHpPose = new Pose(8.38, 8.12, Math.toRadians(-100));
