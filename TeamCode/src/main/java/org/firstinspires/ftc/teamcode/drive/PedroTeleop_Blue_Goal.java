...
@Configurable
@TeleOp(name="TeleOp Blue Goal", group="Linear OpMode")
public class PedroTeleop_Blue_Goal extends OpMode {
    private Follower follower;
    public static Pose startingPose = new Pose(27.0, 130, Math.toRadians(142)); //See ExampleAuto to understand how to use this
    ...
    public void init() {
        ...
        pathChainFar = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(55, 95))))
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(315), 0.8))
                .build();
    }
