...
@Configurable
@Autonomous(name = "BlueBack_p3hs", group = "Examples")
public class BlueBack_p3hs extends OpMode {
    ...
    private final Pose pickup1Setup = new Pose(8, 27, Math.toRadians(-90)); // Setup to pickup balls in the hp zone
    private final Pose pickup1Pose = new Pose(8, 7, Math.toRadians(-90));// balls in the hp zone
    ...
    private final Pose scoopSetup = new Pose(15, 45, Math.toRadians(-135)); // Setup to scoop remaining balls in the hp zone
    private final Pose scoopPose = new Pose(8, 7, Math.toRadians(-90)); // Pose to scoop remaining balls in the hp zone
