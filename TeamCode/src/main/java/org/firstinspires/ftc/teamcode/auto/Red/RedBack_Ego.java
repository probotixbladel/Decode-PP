...
public class RedBack_Ego extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(123.27, 36.36, Math.toRadians(0));
    private final Pose pickup1Controlpoint = new Pose(79.72, 38.66);
    private final Pose pickup2Pose = new Pose(122.18, 59.97, Math.toRadians(0));
    private final Pose pickup2Controlpoint = new Pose(77.05, 63.30);
    private final Pose pickupGatePose = new Pose(133.18, 61.20, Math.toRadians(35));
    private final Pose pickup3Pose = new Pose(122.83, 84.03, Math.toRadians(0));
    private final Pose pickup3Controlpoint = new Pose(73.70, 101.11);
    private final Pose leavePose = new Pose(81.62, 55.49, Math.toRadians(90));
